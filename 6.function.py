...
# 2 вариант
# функция, принимающая параметры (значения, либо данные) (обладает аргументами)
...
# пердаваемый параметр имеет приоритет
# func_4(20, 2)
...
# smeshannaya peredacha parametrov
# func_5(100, c=2)
